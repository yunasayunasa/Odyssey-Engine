...
[chara_jump name="yuna" loop="true" nowait="true"] 
; ユナの跳ねるアニメーションを開始
[move name="yuna" x=400 alpha=1 time=1000]      
 ; ユナを画面左寄りに移動させる
[wait time=1000]
 ; 移動とジャンプが終わるのを待つ
[stop_anim name="yuna"] 
...
[jump storage="ActionScene" params="{player_level:f.love_meter, player_name:'&f.player_name;', start_area:'bridge', current_coin:f.coin}"] 
[fadein time=500]
