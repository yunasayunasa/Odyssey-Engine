// src/scenes/PreloadScene.js (Phaser起動問題を解決するための最低限の修正)
...
export default class PreloadScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.registry.set('configManager', configManager); // ConfigManagerをRegistryにセット！
        ...
        this.load.once('complete', () => {
            ...
            if (systemScene) {
                ...
                // this.game.destroy(true); // ゲーム全体を破棄する
            }
